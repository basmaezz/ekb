        ...
        topics:[
            {
                ...
                content:'<p>1. قم بالضغط على الرابط التالي <a href="http://www.ekb.eg/ar/register">http://www.ekb.eg/ar/register</a> او يمكنك الضغط على مستخدم جديد ) كما في الصورة</p> <img class="content_image" src="'+ app.images[2].img[1] +'"> <p>2.بعد ذلك سوف يطلب منك الموقع تحديد البوابة التي تناسبك ( تم الشرح مسبقا ) وفی حالتنا سوف نختار بوابة الطالب والمعلمون</p><img class="content_image" src="'+ app.images[2].img[0] +'"> <p>3.الان سوف يطلب منك معلومات شخصية قم باستيفاء جميع البيانات كما في الصورة ملحوظة : تأكد من كتابة البريد الالكتروني صحيح لانه سوف يتم إرسال عليه كلمة المرور لهذاالحساب</p><img class="content_image" src="'+ app.images[2].img[3] +'">  <p>4.الان سوف يطلب منك معلومات وظيفية قم باستيفاء جميع البيانات كما في الصورة ملحوظة في حالة الا تكونمادة التدريس غير موجودة بالقائمة نختار اخرى وبعدها سوف يظهر مربع اخر نكتب فيه المادة التي نقوم بتدريسها او اخصائي = NILE</p><img class="content_image" src="'+ app.images[2].img[4] +'"> <p>5.الان بعد كتابة كل البيانات والمعلومات اللازمة اكتب التحقق من التص ) كما بالصورة وضع علامة صح امام مربع ( الموافقة على شروط الاستخدام ) واضغط على مربع &quot; ارسال &quot; بعدها تظهر لك رسالة انه تم بعدها يتم ارسال رسالة الى بريدك الذي سجلت بيه تحت في الرسالة على باسورد حسابك ( كلمة السر )</p><img class="content_image" src="'+ app.images[2].img[5] +'">',
                featured:true,
