    ...
    if (data){
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            if( category.id == category_id){
                for (let x = 0; x < category.topics.length; x++) {
                    const topic = category.topics[x];              
                    topics_html += '<div class="topic_wrapper" data-topic-id="'+topic.id+'" data-topic-title="'+topic.title+'">'+ topic.title +'</div></br>'
        ...
        topics:[
            {
                ...
                content:'<p>1.. قم بالضغط على الرابط التالي <a href="http://www.ekb.eg/ar/register">http://www.ekb.eg/ar/register</a><img class="content_image" src="'+ app.images[2].img[1] +'"> او يمكنك الضغط على مستخدم جديد ) كما في الصورة</p> <p>2.بعد ذلك سوف يطلب منك الموقع تحديد البوابة التي تناسبك ( تم الشرح مسبقا ) وفی حالتنا سوف نختار بوابة الطالب والمعلمون</p> <p>3.الان سوف يطلب منك معلومات شخصية قم باستيفاء جميع البيانات كما في الصورة ملحوظة : تأكد من كتابة البريد الالكتروني صحيح لانه سوف يتم إرسال عليه كلمة المرور لهذاالحساب</p> <p>4.الان سوف يطلب منك معلومات وظيفية قم باستيفاء جميع البيانات كما في الصورة ملحوظة في حالة الا تكونمادة التدريس غير موجودة بالقائمة نختار اخرى وبعدها سوف يظهر مربع اخر نكتب فيه المادة التي نقوم بتدريسها او اخصائي = NILE</p> <p>5.الان بعد كتابة كل البيانات والمعلومات اللازمة اكتب التحقق من التص ) كما بالصورة وضع علامة صح امام مربع ( الموافقة على شروط الاستخدام ) واضغط على مربع &quot; ارسال &quot; بعدها تظهر لك رسالة انه تم بعدها يتم ارسال رسالة الى بريدك الذي سجلت بيه تحت في الرسالة على باسورد حسابك ( كلمة السر )</p><img class="content_image" src="'+ app.images[2].img[0] +'">',
                featured:true,
images: [
            ...
            },
            {
                ...
                content:'<p>1.تظهر لك رسالة انه تم بعدها يتم ارسال رسالة الى بريدك الذي سجلت بيه تحتوي على كلمه المرور الخاصه بك</p><p>2.بعد ذلك افتح صفحة تسجيل الدخول واكتب البريد الالكتروني الذي سجلت به وكلمة السر التي تم ارسالها لك عبر البريد الالكتروني واضغط على تسجيل الدخول بعدها يتم تحويلك الى صفحة جديدة</p><p>3.- بعد ذلك تظهر الشاشة التالية تكتب باسورد جديد خاص بك تكتبه مره اخري للتأكيد 9. اضغط على &quot; إحفظ &quot; بعدها يمكنك تصفح الموقع وتصفح المواد العلمية كما تريد</p><p>4.<a href="http://www.ekb.eg/">http://www.ekb.eg/</a> طريقة فتح موقع بنك المعرفة اما الضغط على الرابط التالي : واما تذهب المتصفح الخاص بك وفي شريط العنوان قم بكتابة ekb.eg قم الضغط على مفتاح الادخال Enter</p><img class="content_image" src="'+ app.images[1].img[0] +'">',
                featured:false,
images: [
   ' img/login.png'
]
...
images: [
    ...
    },
    {
        ...
        topics:[
            {
                id:4,
                title:'التعرف على المحتوى المعرفى لموقع Discovery Education',
                content:'<ol> <li>التعرف على المحتوى المعرفي لموقع Discovery education يعتبر Discovery education احد اهم دور النشر التي توفر محتوى تعليم على موقع بنك المعرفة وهو ربط بين مناهج التعليم المصرية عند الدخول على قائمة مصادرنا ثم كل المصادر سوف يفتح لك جميع المصادر : المصادر المتاحة مصدر ( Discovery education ) ثم اكتشف المزيد</li> <li>يوفر محتوى فيديو تعليمي مناسب للمناهج الدراسية للمراحل التعليمية ابتدائي - اعدادي - ثانوی ) | للبحث ثم بالذهاب الى مربع النص أعلى النافذة ثم قم بكتابة اي منهج تريد البحث عنه ثم الضغط على أمر بحث مثال : قم بكتابة كلمة وحدات القياس في خانة البحث المتقدم وانظر ماذا اترى سوف ترى الشاشة التالية وفق للجدول 1 مكان لعبة كلمة البحث ثم الضغط علي امر بحث کد تقع البحث التي نتجت قمة الفرن على حسب المرحلة التعليمية وستلاحظ عند اختيار مرحلة معينة سوف يتغير عدد نتائج البحث نبع البحث التي تنجت المشاركة مقطع الفيديو على الفيس بوك او تويتر أو غيره</li> <li>هو ربط المنهج المصري بمحتوى رقمي ممتع . فلم يعد المعلمون بحاجة للبحت على نطاق واسع عن موارد رقمية لدعم دروسهم ويمكن للطلاب دراستها سرا . يوفر Curriculum Connect الوصول عبر الإنترنت وعبر الهاتف المحمول إلى الآلاف من مقاطع الفيديو ، والمقالات النصية ، والعروض التفاعلية ، وملفات الصوت والصور المدققة التي تم تعيينها إلى كل دروس العلوم والرياضيات لجميع المراحل الدراسية الابتدائي - الإعدادي - الثانوي</li> </ol> <p>4.قم باختيار من Curriculum Connect المرحلة الابتدائية سوف تجد هنا الكورسات او مقاطع الفيديو الخاصة بالوحدة التي قمت باختيارها</p> <p>5.تابع مثال قم باختيار من Connect Curriculum المرحلة الابتدائية وبعد اختيار الكورس او الفيديو سوف يقوم بافتع مباشرة ويمكنك تغيير لغة الفيديو وكذلك يمكن مشاركته على مواقع التواصل ويوجد اسف الفيديو اشارات مرجعية Tags لالفاظ ورد ذكرها داخل الفيديو تساعد الطالب المعرفة اكثر عن اي لفظ من هذه الألفاظ بمجرد الضغط عليها ومن ثم يتنقوم الي ناتج بحث اضافی</p> <p>5.المصدر Discovery education استخدام WebEdTV قرقر شبكة WebEdTV للمدرسين ، والأباء ، والطلاب مجموعة منتقاة من أفضل الموارد المعلوماتية الشيقة من مجموعة مقاطع الفيديو ذات المستوى العالمي من إنتاج .Discovery Education ويتم انتقاء الموارد بعناية لتتلاءم مع موضوعات المناهج الدراسية لطلاب المراحل الابتدائية ، والإعدانية ، والثانوية في كل أسبوع ، يتم اختيار موارد في خمس مواد ، هي : العلوم والرياضيات ، ومهن STEM ، ومهارات القرن الحادي والعشرين ، والموضوعات العالمية ، بالإضافة إلى مقاطع فيديو تمهيدية مخصصة ، واستراتيجيات تدريس و أدلة تعلم لإثارة الفضول ودعم التعلم في المدرسة أو في المنزل</p> <p>6.استخدام WebEdTV هي عبارة عن قناة تليفزيونية يتم بثها يوميا عبر الانترنت من الأحد إلى الخميس لمدة ثلاثة ساعات تقدم مجموعة الفيديوهات التعليمية للمراحل الإبتدائية والاعدادية والثانوية وجميع الفيديوهات يتم اعادة عرضها يوم السبت - الان قم باختيار المرحلة التي تناسبك 1 لتحديد الشهر واليوم أو الأمابيع العرض المادة نتائح العرض يمكنك أيضا تنزيل أضواء على استراتيجيات التعلم الأداء الحركي والتي يتم فيها عرض الاستراتيجية المستخدمة والخطوات الإجرائية التي يمكن للمعلم أن يتبعها داخل الفصل لتحقيق نوع من انواع من التعلم النشط مع تلاميذه</p> <ol> <li>استخدام WebEdTV بعد الضغط على الفيديو التي قمت باختيارة يمكنك من عرض قائمة التشغيل المتعلقة او المرتبطة بذلك الفيديو ويمكنك من تنزيل بديل التعليم على هيئة كتاب PDF</li> </ol><img class="content_image" src="'+ app.images[4].img[0] +'"><img class="content_image" src="'+ app.images[4].img[1] +'">',
                featured:false,
images: [
...
images: [
            ...
            {
                id:6,
                title:'مكتبه العبيكان',
                content:'<p>1.المصدر مكتبة العبيكان تعتبر مكتبة العبيكان | هي مكتية للكتب باللغة العربية والتي تحتوي على ما يقرب من ۲۹۰۰۰ كتاب تناسب جميع التخصسسات والاهتمامات بالإضافة إلى بعض المصادر البحثية المختلفة</p><ol><li>أنشئت مكتبة العبيكان لكي تكون منارة للفكر والثقافة تضيء من المملكة العربية السعودية للعالم العربي كله ، وقد تبنت مكتبة العبيكان منذ إنشائها نهجا مبنية على تحمل مسؤوليتها الاجتماعية في نشر العلم والثقافة والمعرفة بين أبناء الوطن والمنطقة ، وهذا ماتجلى في إسهامها في عالم النشر والترجمة . إذ بلغت إصداراتها أكثر من ثلاث آلاف عنوان في كافة التخصصات وفروع العلم والمعرفة . تقوم بتوزيعها على مستوى العالم العربي عبر وكلائها ومكاتبها المنتشرة في العوا العربية ، وعبر المشاركة في جميع المعارض الدولية على مستوى العالم . تعد مكتبة العبيكان أحد أكبر المكتبات في العالم العربي والشرق الأوسط ، فهي تمتد إلى ۲۰ فرعا في جميع أنحاء المملكة ، تضم أكثر من مئة ألف من العناوين العربية والأجنبية توفرها لكل قارئ أو باحث أو طالب علم ، كما تضم مكتبة متخصصة للطفل تلبي كافة احتياجاتة المعرفية والتربوية . وقد قامت المكتبة بإتاحة محتوى رقمي يخدم الاحتياجات التعليمية والبحثية والمعرفية للدارسين والباحثين والمثقفين المهتمين بالمحتوى العربي من خلال التطوير المستمر لمكتبة العبيكان الرقمية وقاعدة بيانات إثراء المعارف الرقمية والتي يمكن استخدامها من خلال منصة بحث وواجهات تعامل معيارية ، وآليات الفهرسة والتكشيف وفقا للمعايير الدولية وبما يحقق التكامل المعر والتكنولوجي في الوقت نفسه</li></ol><img class="content_image" src="'+ app.images[6].img[0] +'"><img class="content_image" src="'+ app.images[6].img[1] +'"><img class="content_image" src="'+ app.images[6].img[2] +'">',
                featured:false,
images: [
...
images: [
            ...
            {
                id:12,
                title:'المصدر National Geographic',
