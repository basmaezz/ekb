...
app.get_categories = function(){
    ...
    if (data){
        ...
        for (var i = 0; i < data.length; i++) {
            var category = data[i];
            categories_list += '<div class="category_wrapper" data-category-id="'+category.id+'" data-category-name="'+category.name+'"><ons-card>'+ category.name +'</ons-card></div>'
        }
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            for (let x = 0; x < category.topics.length; x++) {
                ...
                if(topic.featured == true){
                    featured_html += '<div class="topic_wrapper" data-topic-id="'+topic.id+'"><ons-card>'+ topic.title +'</ons-card></div>'
                }
            }
        }
        ...
        topics:[
            {
                ...
                content:'<p>1.. قم بالضغط على الرابط التالي <a href="http://www.ekb.eg/ar/register">http://www.ekb.eg/ar/register</a> او يمكنك الضغط على مستخدم جديد ) كما في الصورة</p> <img class="content_image" src="'+ app.images[2].img[1] +'"> <p>2.بعد ذلك سوف يطلب منك الموقع تحديد البوابة التي تناسبك ( تم الشرح مسبقا ) وفی حالتنا سوف نختار بوابة الطالب والمعلمون</p><img class="content_image" src="'+ app.images[2].img[0] +'"> <p>3.الان سوف يطلب منك معلومات شخصية قم باستيفاء جميع البيانات كما في الصورة ملحوظة : تأكد من كتابة البريد الالكتروني صحيح لانه سوف يتم إرسال عليه كلمة المرور لهذاالحساب</p>  <p>4.الان سوف يطلب منك معلومات وظيفية قم باستيفاء جميع البيانات كما في الصورة ملحوظة في حالة الا تكونمادة التدريس غير موجودة بالقائمة نختار اخرى وبعدها سوف يظهر مربع اخر نكتب فيه المادة التي نقوم بتدريسها او اخصائي = NILE</p> <p>5.الان بعد كتابة كل البيانات والمعلومات اللازمة اكتب التحقق من التص ) كما بالصورة وضع علامة صح امام مربع ( الموافقة على شروط الاستخدام ) واضغط على مربع &quot; ارسال &quot; بعدها تظهر لك رسالة انه تم بعدها يتم ارسال رسالة الى بريدك الذي سجلت بيه تحت في الرسالة على باسورد حسابك ( كلمة السر )</p>',
                featured:true,
images: [
